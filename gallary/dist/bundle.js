...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"slideShow\": () => (/* binding */ slideShow)\n/* harmony export */ });\n/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index */ \"./src/index.js\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\nfunction _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\n\n\n\nclass slideShow {\n  constructor() {\n    _defineProperty(this, \"currentSlide\", 0);\n\n    _defineProperty(this, \"interval\", null);\n  }\n\n  slideInterval(isPlaying) {\n    if (isPlaying) {\n      this.interval = setInterval(() => this.nextSlide(), 2000);\n    } else {\n      clearInterval(this.interval);\n    }\n  }\n\n  next() {\n    for (var i = 0; i < _index__WEBPACK_IMPORTED_MODULE_0__.Dom.controls.length; i++) {\n      _index__WEBPACK_IMPORTED_MODULE_0__.Dom.controls[i].style.display = 'inline-block';\n    }\n  }\n\n  nextSlide() {\n    this.goToSlide(this.currentSlide + 1);\n  }\n\n  previousSlide() {\n    this.goToSlide(this.currentSlide - 1);\n  }\n\n  goToSlide(n) {\n    console.log('here', n);\n    _index__WEBPACK_IMPORTED_MODULE_0__.Dom.slides[this.currentSlide].className = 'slide';\n    this.currentSlide = (n + _index__WEBPACK_IMPORTED_MODULE_0__.Dom.slides.length) % _index__WEBPACK_IMPORTED_MODULE_0__.Dom.slides.length;\n    _index__WEBPACK_IMPORTED_MODULE_0__.Dom.slides[this.currentSlide].className = 'slide showing';\n    this.next();\n  }\n\n  pauseSlideshow() {\n    // debugger\n    // console.log('here')\n    _index__WEBPACK_IMPORTED_MODULE_0__.Dom.pauseButton.innerHTML = '&#9658;'; // play character\n\n    _index__WEBPACK_IMPORTED_MODULE_0__.Dom.playing = false;\n    this.slideInterval(_index__WEBPACK_IMPORTED_MODULE_0__.Dom.playing); // clearInterval(this.slideInterval);\n  }\n\n  playSlideshow() {\n    _index__WEBPACK_IMPORTED_MODULE_0__.Dom.pauseButton.innerHTML = '&#10074;&#10074;'; // pause character\n\n    _index__WEBPACK_IMPORTED_MODULE_0__.Dom.playing = true;\n    this.slideInterval(_index__WEBPACK_IMPORTED_MODULE_0__.Dom.playing); // this.slideInterval = setInterval(this.nextSlide, 2000);\n    // this.slideInterval = setInterval(this.nextSlide, 2000);\n  }\n\n} // export const gallery = new slideShow()\n\n_index__WEBPACK_IMPORTED_MODULE_0__.Dom.pauseButton.addEventListener('click', () => {\n  if (_index__WEBPACK_IMPORTED_MODULE_0__.Dom.playing) {\n    gallery.pauseSlideshow();\n  } else {\n    gallery.playSlideshow();\n  }\n});\n_index__WEBPACK_IMPORTED_MODULE_0__.Dom.next.addEventListener('click', () => {\n  gallery.pauseSlideshow();\n  gallery.nextSlide();\n});\n_index__WEBPACK_IMPORTED_MODULE_0__.Dom.previous.addEventListener('click', () => {\n  gallery.pauseSlideshow();\n  gallery.previousSlide();\n});\naddEventListener('DOMContentLoaded', () => gallery.playSlideshow());\n\n//# sourceURL=webpack://packege-name/./src/main.js?");
